...
public class MessagingConstants {
	...
	public static final String FROM_BBB_APPS_TOPICS = "bigbluebutton:from-bbb-apps:system,"
			+ "bigbluebutton:from-bbb-apps:meeting,"
			+ "bigbluebutton:from-bbb-apps:presentation,"
			+ "bigbluebutton:from-bbb-apps:polling,"
			+ "bigbluebutton:from-bbb-apps:users,"
			+ "bigbluebutton:from-bbb-apps:chat,"
			+ "bigbluebutton:from-bbb-apps:whiteboard,"
			+ "bigbluebutton:from-bbb-apps:keepalive";

	public static final String TO_BBB_APPS_TOPICS = "bigbluebutton:to-bbb-apps:meeting,"
			+ "bigbluebutton:to-bbb-apps:system,"
			+ "bigbluebutton:to-bbb-apps:presentation,"
			+ "bigbluebutton:to-bbb-apps:polling,"
